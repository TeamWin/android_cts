...
import static android.mediav2.common.cts.CompareStreams.fillByteArray;
 ...
 * <p>
 * The class computes the PSNR between encoders output and input. The functionality of this class
 * is very similar to {@link CompareStreams} with the upside of using much less storage space. This
 * class does not save the decoded output to a file. Instead it decodes a frame, compares it with
 * reference frame, preserves the error statistics, discards decoded yuv. This is repeated until
 * EOS. No writing the decoded output of test file to disk.
 * TODO (b/278691701): Update all tests to use this class for encoder output validation.
 */
public class CompareStreams2 extends CodecDecoderTestBase {
    private static final String LOG_TAG = CompareStreams2.class.getSimpleName();
    ...
    private CompareStreams2(RawResource refYuv, String testMediaType, String testFile,
    ...
    public CompareStreams2(RawResource refYuv, String testMediaType, String testFile,
    ...
    public CompareStreams2(MediaFormat refFormat, ByteBuffer refBuffer,
    ...
    public CompareStreams2(String refMediaType, String refFile, String testMediaType,
