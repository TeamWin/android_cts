...
public class BluetoothServiceManagerTest extends AndroidTestCase {
    ...
    public void test_ServiceRegisterer() {
        ...
        IBluetoothManager bluetoothService =
                IBluetoothManager.Stub.asInterface(serviceRegisterer.get());
        assertNotNull(bluetoothService);

        bluetoothService =
                IBluetoothManager.Stub.asInterface(serviceRegisterer.tryGet());
        assertNotNull(bluetoothService);

        try {
            bluetoothService =
                    IBluetoothManager.Stub.asInterface(serviceRegisterer.getOrThrow());
            assertNotNull(bluetoothService);
