...
public class StaticLayoutTest {
    ...
    public void testBuilder() {
        ...
        }
        {
            ...
            StaticLayout.Builder builder = StaticLayout.Builder.obtain((CharSequence) null, 0, 0,
                    null, 0);
            try {
                StaticLayout layout = builder.build();
        ...
        }
        {
            try {
                // Obtain with null objects.
                StaticLayout.Builder builder = StaticLayout.Builder.obtain((PrecomputedText) null,
                        0, 0, null, 0);
                fail("should throw NullPointerException here");
            } catch (NullPointerException e) {
            }
    ...
    */
    ...
    void assertSameStaticLayout(CharSequence text, LayoutParam measuredTextParam,
        ...
        final Layout resultLayout = StaticLayout.Builder.obtain(mt, 0, mt.getText().length(),
