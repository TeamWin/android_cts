...
public final class Egl14Utils {
    ...
    public static int getMaxTextureSize() {
        // SystemProperties.getInt() is not TestApi at android10, need to convert string to int
        String maxTextureSizeTemp = SystemProperties.get("sys.max_texture_size", "0");
        int maxTextureSize = Integer.valueOf(maxTextureSizeTemp);
