...
/**
 * Tests for {@link HotwordDetectionService} without allow shared isolated tags defined.
 */
@RunWith(AndroidJUnit4.class)
@AppModeFull(reason = "No real use case for instant mode hotword detection service")
public class HotwordDetectionServiceNonSharedIsolatedTest {

    private static final String TAG = "HotwordDetectionServiceNonSharedIsolatedTest";
