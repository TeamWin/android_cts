...
/**
 * Tests for {@link VisualQueryDetectionService} without allow shared isolated tags defined.
 */
@RunWith(AndroidJUnit4.class)
@AppModeFull(reason = "No real use case for instant mode visual query detection service")
public class VisualQueryDetectionServiceNonSharedIsolatedTest {
    ...
    public void testVisualQueryDetectionService_noIsolatedTags_triggerFailure()
        ...
        // to get service.
        NonSharedIsolatedHotwordDetectionVoiceInteractionService service =
                (NonSharedIsolatedHotwordDetectionVoiceInteractionService)
