...
import static android.virtualdevice.cts.util.TestAppHelper.createActivityLaunchedReceiverIntent;
...
public class RecentTasksTest {
    ...
    public void setUp() {
        ...
        context.getSystemService(ActivityTaskManager.class).removeAllVisibleRecentTasks();
    }
    ...
    private Bundle launchTestActivity(VirtualDevice virtualDevice, VirtualDisplay virtualDisplay)
        ...
        Intent intent = createActivityLaunchedReceiverIntent(
                createResultReceiver(activityResultCallback)).addFlags(
    ...
    private static class ActivityResultCallback implements
        ...
        public Bundle waitForActivityResult() throws ExecutionException, TimeoutException {
            return Uninterruptibles.getUninterruptibly(mResultBundle, 5, TimeUnit.SECONDS);
        }
