...
public class MockMediaLibraryService2 extends MediaLibraryService2 {
    ...
    public void onCreate() {
        super.onCreate();
        TestMediaSessionService2Registry.getInstance().setServiceInstance(this);
    }
    ...
    public MediaLibrarySession onCreateSession(String sessionId) {
        ...
        final SyncHandler handler =
                (SyncHandler) TestMediaSessionService2Registry.getInstance().getHandler();
        final Executor executor = (runnable) -> handler.post(runnable);
        SessionCallbackProxy sessionCallbackProxy =
                TestMediaSessionService2Registry.getInstance().getSessionCallbackProxy();
