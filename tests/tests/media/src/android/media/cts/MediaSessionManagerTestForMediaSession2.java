...
@SmallTest
public class MediaSessionManagerTestForMediaSession2 extends MediaSession2TestBase {
    private static final String TAG = "MediaSessionManagerTestForMediaSession2";
