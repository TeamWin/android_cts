...
import android.media.cts.TestMediaSessionService2Registry.SessionCallbackProxy;
...
import static android.media.cts.MediaSession2TestUtils.ensurePlaylistParamsModeEquals;
...
public class MediaController2Test extends MediaSession2TestBase {
    ...
    public void setUp() throws Exception {
        ...
        TestMediaSessionService2Registry.getInstance().setHandler(sHandler);
    }
    ...
    public void cleanUp() throws Exception {
        ...
        TestMediaSessionService2Registry.getInstance().cleanUp();
    }
    ...
    */
    ...
    public void testSendCustomCommand() throws InterruptedException {
        ...
        final SessionCallback callback = new SessionCallback(mContext) {
            ...
            public void onCustomCommand(ControllerInfo controller, Command customCommand,
                ...
                assertTrue(MediaSession2TestUtils.equals(testArgs, args));
                assertNull(cb);
                latch.countDown();
            }
        };
    ...
    public void testPlayFromSearch() throws InterruptedException {
        ...
        final SessionCallback callback = new SessionCallback(mContext) {
            ...
            public void onPlayFromSearch(ControllerInfo controller, String query, Bundle extras) {
                ...
                assertTrue(MediaSession2TestUtils.equals(bundle, extras));
                latch.countDown();
            }
        };
    ...
    public void testGetServiceToken() {
        SessionToken2 token =
                MediaSession2TestUtils.getServiceToken(mContext, MockMediaSessionService2.ID);
        assertNotNull(token);
    ...
    private void connectToService(SessionToken2 token) throws InterruptedException {
        ...
        mSession = TestMediaSessionService2Registry.getInstance().getServiceInstance().getSession();
    ...
    public void testConnectToService(String id) throws InterruptedException {
        ...
        TestMediaSessionService2Registry.getInstance().setSessionCallbackProxy(proxy);
        connectToService(MediaSession2TestUtils.getServiceToken(mContext, id));
        assertTrue(latch.await(TIMEOUT_MS, TimeUnit.MILLISECONDS));
        ...
        mPlayer.notifyPlaybackState(
                MediaSession2TestUtils.createPlaybackState(PlaybackState.STATE_REWINDING));
        assertTrue(latch.await(WAIT_TIME_MS, TimeUnit.MILLISECONDS));
        */
    }
    ...
    private void testCloseFromService(String id) throws InterruptedException {
        ...
        TestMediaSessionService2Registry.getInstance().setSessionCallbackProxy(proxy);
        mController = createController(MediaSession2TestUtils.getServiceToken(mContext, id));
        mController.close();
        // Wait until close triggers onDestroy() of the session service.
        assertTrue(latch.await(WAIT_TIME_MS, TimeUnit.MILLISECONDS));
        assertNull(TestMediaSessionService2Registry.getInstance().getServiceInstance());
        testNoInteraction();
    ...
    private void testNoInteraction() throws InterruptedException {
        ...
        mPlayer.notifyPlaybackState(
                MediaSession2TestUtils.createPlaybackState(PlaybackState.STATE_BUFFERING));
