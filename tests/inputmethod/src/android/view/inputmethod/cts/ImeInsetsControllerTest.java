...
public class ImeInsetsControllerTest extends EndToEndImeTestBase {
    ...
    private static final int INITIAL_KEYBOARD_HEIGHT = 100;
    private static final int NEW_KEYBOARD_HEIGHT = 200;
    ...
    public void testChangeSizeWhileControlling() throws Exception {
        try (MockImeSession imeSession = MockImeSession.create(
                ...
                new ImeSettings.Builder()
                        .setInputViewHeightWithoutSystemWindowInset(INITIAL_KEYBOARD_HEIGHT))) {
            ...
            assertEquals(INITIAL_KEYBOARD_HEIGHT, lastInsets[0].getInsets(ime()).bottom
                    - lastInsets[0].getInsets(systemBars()).bottom);
