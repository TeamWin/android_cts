 ...
 *
 * Each test class should have its own trust agent. To create a new trust agent:
 *   - extend from this class
 *       - add a companion object method
 *         `fun instance() = instance(YourTrustAgent::class) as YourTrustAgent`
 *   - add YourTrustAgent as a new <service> in cts/tests/trust/AndroidManifest.xml
 */
