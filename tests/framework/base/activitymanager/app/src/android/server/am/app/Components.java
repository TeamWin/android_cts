...
public class Components extends ComponentsBase {
    ...
    /**
     * This activity is an alias activity pointing {@link android.server.am.app.TrampolineActivity}
    ...
    public static class LaunchBroadcastReceiver {
        public static final String LAUNCH_BROADCAST_ACTION =
                "android.server.am.app.LAUNCH_BROADCAST_ACTION";

        public static final String ACTION_TEST_ACTIVITY_START =
                "android.server.am.app.ACTION_TEST_ACTIVITY_START";
    ...
    /**
     * The keys are used for {@link android.server.am.TestJournalProvider} when testing wallpaper
     * component.
     */
     ...
     *
     * TODO(b/73346885): These constants should be in {@link android.server.am.app.TestActivity}
    ...
    public static class TestActivity {
        ...
        public static final String TEST_ACTIVITY_ACTION_FINISH_SELF =
                "android.server.am.app.TestActivity.finish_self";
     ...
     * {@link android.server.am.app.AssistantActivity} once the activity is moved to test APK.
     */
    ...
    /**
     * Extra key constants for {@link android.server.am.app.BottomActivity}.
     *
     * TODO(b/73346885): These constants should be in {@link android.server.am.app.BottomActivity}
     * once the activity is moved to test APK.
     */
    ...
    /**
     * Extra key constants for {@link android.server.am.app.BroadcastReceiverActivity}.
     *
     * TODO(b/73346885): These constants should be in
     * {@link android.server.am.app.BroadcastReceiverActivity} once the activity is moved to test APK.
     */
    ...
    /** Extra key constants for {@link android.server.am.app.FontScaleActivity}. */
    ...
    /**
     *  Logging constants for {@link android.server.am.app.KeyguardDismissLoggerCallback}.
     *
     * TODO(b/73346885): These constants should be in
     * {@link android.server.am.app.KeyguardDismissLoggerCallback} once the class is moved to test APK.
     */
     ...
     *
     * TODO(b/73346885): These constants should be in
     * {@link android.server.am.app.LaunchAssistantActivityIntoAssistantStack} once the activity is
     * moved to test APK.
     */
    ...
    /**
     * Extra constants for {@link android.server.am.app.MoveTaskToBackActivity}.
     *
     * TODO(b/73346885): These constants should be in
     * {@link android.server.am.app.MoveTaskToBackActivity} once the activity is moved to test APK.
     */
    ...
    /**
     * Action and extra key constants for {@link android.server.am.app.PipActivity}.
     *
     * TODO(b/73346885): These constants should be in {@link android.server.am.app.PipActivity}
     * once the activity is moved to test APK.
     */
    public static class PipActivity {
        // Intent action that this activity dynamically registers to enter picture-in-picture
        public static final String ACTION_ENTER_PIP = "android.server.am.app.PipActivity.enter_pip";
        ...
        public static final String ACTION_MOVE_TO_BACK =
                "android.server.am.app.PipActivity.move_to_back";
        ...
        public static final String ACTION_EXPAND_PIP =
                "android.server.am.app/PipActivity.expand_pip";
        ...
        public static final String ACTION_SET_REQUESTED_ORIENTATION =
                "android.server.am.app.PipActivity.set_requested_orientation";
        // Intent action that will finish this activity
        public static final String ACTION_FINISH = "android.server.am.app.PipActivity.finish";
    ...
    /**
     * Extra key constants for {@link android.server.am.app.TopActivity} and
     * {@link TranslucentTopActivity}.
     *
     * TODO(b/73346885): These constants should be in {@link android.server.am.app.TopActivity}
     * once the activity is moved to test APK.
     */
    ...
    /**
     * Extra key constants for {@link android.server.am.app.VirtualDisplayActivity}.
     *
     * TODO(b/73346885): These constants should be in
     * {@link android.server.am.app.VirtualDisplayActivity} once the activity is moved to test APK.
     */
