...
import static android.server.am.app.Components.ALWAYS_FOCUSABLE_PIP_ACTIVITY;
import static android.server.am.app.Components.LAUNCHING_ACTIVITY;
import static android.server.am.app.Components.LAUNCH_ENTER_PIP_ACTIVITY;
import static android.server.am.app.Components.LAUNCH_INTO_PINNED_STACK_PIP_ACTIVITY;
...
import static android.server.am.app.Components.PIP_ACTIVITY2;
import static android.server.am.app.Components.PIP_ACTIVITY_WITH_SAME_AFFINITY;
import static android.server.am.app.Components.PIP_ON_STOP_ACTIVITY;
...
import static android.server.am.app.Components.PipActivity.ACTION_FINISH;
import static android.server.am.app.Components.PipActivity.ACTION_MOVE_TO_BACK;
import static android.server.am.app.Components.PipActivity.EXTRA_ASSERT_NO_ON_STOP_BEFORE_PIP;
import static android.server.am.app.Components.PipActivity.EXTRA_ENTER_PIP;
import static android.server.am.app.Components.PipActivity.EXTRA_ENTER_PIP_ASPECT_RATIO_DENOMINATOR;
import static android.server.am.app.Components.PipActivity.EXTRA_ENTER_PIP_ASPECT_RATIO_NUMERATOR;
import static android.server.am.app.Components.PipActivity.EXTRA_ENTER_PIP_ON_PAUSE;
import static android.server.am.app.Components.PipActivity.EXTRA_FINISH_SELF_ON_RESUME;
import static android.server.am.app.Components.PipActivity.EXTRA_ON_PAUSE_DELAY;
import static android.server.am.app.Components.PipActivity.EXTRA_PIP_ORIENTATION;
import static android.server.am.app.Components.PipActivity.EXTRA_SET_ASPECT_RATIO_DENOMINATOR;
import static android.server.am.app.Components.PipActivity.EXTRA_SET_ASPECT_RATIO_NUMERATOR;
import static android.server.am.app.Components.PipActivity.EXTRA_START_ACTIVITY;
import static android.server.am.app.Components.PipActivity.EXTRA_TAP_TO_FINISH;
import static android.server.am.app.Components.RESUME_WHILE_PAUSING_ACTIVITY;
import static android.server.am.app.Components.TEST_ACTIVITY;
import static android.server.am.app.Components.TEST_ACTIVITY_WITH_SAME_AFFINITY;
