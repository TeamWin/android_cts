...
import static android.server.am.app.Components.LAUNCH_PIP_ON_PIP_ACTIVITY;
import static android.server.am.app.Components.MOVE_TASK_TO_BACK_ACTIVITY;
import static android.server.am.app.Components.MoveTaskToBackActivity.EXTRA_FINISH_POINT;
import static android.server.am.app.Components.MoveTaskToBackActivity.FINISH_POINT_ON_PAUSE;
import static android.server.am.app.Components.MoveTaskToBackActivity.FINISH_POINT_ON_STOP;
import static android.server.am.app.Components.NO_HISTORY_ACTIVITY;
import static android.server.am.app.Components.SWIPE_REFRESH_ACTIVITY;
import static android.server.am.app.Components.TEST_ACTIVITY;
import static android.server.am.app.Components.TRANSLUCENT_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_ATTR_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_ATTR_REMOVE_ATTR_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_SHOW_ON_LOCK_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_SINGLE_TASK_ACTIVITY;
import static android.server.am.app.Components.TURN_SCREEN_ON_WITH_RELAYOUT_ACTIVITY;
