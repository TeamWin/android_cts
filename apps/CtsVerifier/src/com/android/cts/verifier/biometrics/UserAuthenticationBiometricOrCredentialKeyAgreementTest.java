...
public class UserAuthenticationBiometricOrCredentialKeyAgreementTest
        extends AbstractUserAuthenticationKeyAgreementTest {
    private static final String TAG = "UserAuthenticationBiometricOrCredentialKeyAgreementTest";
