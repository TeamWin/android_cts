...
public class UwbPrecisionActivity extends PassFailButtons.Activity {
    ...
    // Thresholds
    private static final int MIN_DISTANCE_RANGE_CM = 10;
    private static final int MIN_ANGLE_OF_ARRIVAL_RANGE_DEGREES = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeviceFeatureChecker.checkUwbFeature(this, getPassButton(),
                getString(R.string.uwb_not_supported));
    ...
    private void checkTestInputs() {
        if (checkDistanceRangeInput() && checkAoaRangeInput() && checkReferenceDeviceInput()) {
    ...
    private boolean checkDistanceRangeInput() {
        ...
        if (!distanceRangeInput.isEmpty()) {
            ...
            // passed.
            return distanceRange < MIN_DISTANCE_RANGE_CM;
        }
        return false;
    }
    ...
    private boolean checkAoaRangeInput() {
        ...
        if (!aoaRangeInput.isEmpty()) {
            ...
            return aoaRange < MIN_ANGLE_OF_ARRIVAL_RANGE_DEGREES;
        }
        return true;
    }
