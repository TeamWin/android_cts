 ...
 */
public class AudioInputDeviceNotificationsActivity extends AudioDeviceNotificationsBaseActivity {
    // ReportLog Schema
    private static final String SECTION_INPUT_DEVICE_NOTIFICATIONS = "input_device_notifications";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAudioManager.registerAudioDeviceCallback(
                new TestAudioDeviceCallback(TestAudioDeviceCallback.SCANTYPE_INPUT), null);
    ...
    public final String getReportSectionName() {
        return setTestNameSuffix(sCurrentDisplayMode, SECTION_INPUT_DEVICE_NOTIFICATIONS);
    }
}
