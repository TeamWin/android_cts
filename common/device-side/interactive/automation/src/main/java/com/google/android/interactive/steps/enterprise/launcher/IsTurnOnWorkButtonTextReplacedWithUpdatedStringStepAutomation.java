...
@AutomationFor("com.google.android.interactive.steps.enterprise.launcher.IsTurnOnWorkButtonTextReplacedWithUpdatedStringStep")

public class IsTurnOnWorkButtonTextReplacedWithUpdatedStringStepAutomation implements Automation<Boolean> {
    @Override
