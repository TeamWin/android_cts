...
@AutomationFor("com.android.interactive.steps.enterprise.bugreport.BugReportNotificationShareBugReportStep")
class BugReportNotificationShareBugReportStepAutomation : Automation<Nothing> {
    override fun automate(): Nothing {
        ...
        // Select share
        TestApis.ui().device().findObject(
            UiSelector().packageName("com.android.settings").textContains("SHARE")
                .resourceId("android:id/button1").className(Button::class.java)
        ).click()
