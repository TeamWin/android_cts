...
@AutomationFor("com.android.interactive.steps.settings.password.SetPin1591Step")
public final class SetPin1591StepAutomation implements Automation<Nothing> {
    @Override
    public Nothing automate() throws Exception {
        ...
        TestApis.ui().device().findObject(
                new UiSelector()
                        .className(EditText.class)).setText("1591");
