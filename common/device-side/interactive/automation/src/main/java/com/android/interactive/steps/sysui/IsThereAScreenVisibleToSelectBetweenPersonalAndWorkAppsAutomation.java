...
@AutomationFor("com.android.interactive.steps.sysui.IsThereAScreenVisibleToSelectBetweenPersonalAndWorkApps")
public class IsThereAScreenVisibleToSelectBetweenPersonalAndWorkAppsAutomation implements
        Automation<Boolean> {
