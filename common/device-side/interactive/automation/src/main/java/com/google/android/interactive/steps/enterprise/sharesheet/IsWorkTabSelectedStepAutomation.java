...
@AutomationFor("com.google.android.interactive.steps.enterprise.sharesheet.IsWorkTabSelectedStep")
public final class IsWorkTabSelectedStepAutomation implements Automation<Boolean> {
    @Override
