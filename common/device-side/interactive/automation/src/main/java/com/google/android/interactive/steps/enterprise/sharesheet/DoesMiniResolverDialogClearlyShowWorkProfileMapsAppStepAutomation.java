...
@AutomationFor("com.google.android.interactive.steps.enterprise.sharesheet"
        + ".DoesMiniResolverDialogClearlyShowWorkProfileMapsAppStep")
public final class DoesMiniResolverDialogClearlyShowWorkProfileMapsAppStepAutomation implements
        Automation<Boolean> {
    @Override
