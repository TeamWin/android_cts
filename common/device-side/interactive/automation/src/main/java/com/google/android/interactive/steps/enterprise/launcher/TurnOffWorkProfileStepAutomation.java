...
@AutomationFor("com.google.android.interactive.steps.enterprise.launcher.TurnOffWorkProfileStep")
public final class TurnOffWorkProfileStepAutomation implements Automation<Nothing> {
    @Override
