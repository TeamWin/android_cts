...
import static com.android.bedstead.nene.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_MICROPHONE;
...
@EnterprisePolicy(dpc = {
        ...
        APPLIED_BY_PROFILE_OWNER | APPLIED_BY_PARENT_INSTANCE_OF_ORGANIZATIONAL_OWNED_PROFILE_OWNER_PROFILE | APPLIED_BY_DPM_ROLE_HOLDER | APPLIES_TO_OWN_USER | CANNOT_BE_APPLIED_BY_ROLE_HOLDER
