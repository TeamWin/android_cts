...
@EnterprisePolicy(dpc = { // APPLIED_BY_DPM_ROLE_HOLDER
        APPLIED_BY_DEVICE_OWNER | APPLIED_BY_FINANCED_DEVICE_OWNER | APPLIED_BY_PROFILE_OWNER | APPLIED_BY_PARENT_INSTANCE_OF_PROFILE_OWNER_PROFILE | APPLIES_GLOBALLY,
