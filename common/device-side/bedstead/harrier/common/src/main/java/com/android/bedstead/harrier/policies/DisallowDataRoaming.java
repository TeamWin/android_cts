...
@EnterprisePolicy(dpc = {
        ...
        APPLIED_BY_PARENT_INSTANCE_OF_ORGANIZATIONAL_OWNED_PROFILE_OWNER_PROFILE | APPLIED_BY_PROFILE_OWNER_USER_WITH_NO_DO | APPLIED_BY_DPM_ROLE_HOLDER | APPLIES_TO_OWN_USER
