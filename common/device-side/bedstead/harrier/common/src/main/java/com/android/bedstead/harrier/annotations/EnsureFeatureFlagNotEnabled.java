...
/**
 * Mark that a test method should disable the given feature flag before running.
 *
 * <p>This should be used with {@code DeviceState}.
 *
 * <p>If you'd rather the test was skipped or failed when the feature flag is enabled, see
 * {@link RequireFeatureFlagNotEnabled}.
 */
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(EnsureFeatureFlagNotEnabledGroup.class)
public @interface EnsureFeatureFlagNotEnabled {
    String namespace();
    String key();
