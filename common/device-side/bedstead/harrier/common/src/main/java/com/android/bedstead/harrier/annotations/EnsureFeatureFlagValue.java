...
/**
 * Mark that a test method should set the given feature flag to the given value before running.
 *
 * <p>This should be used with {@code DeviceState}.
 *
 * <p>If you'd rather the test was skipped or failed when the feature flag is not the given value,
 * see {@link RequireFeatureFlagValue}.
 */
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(EnsureFeatureFlagValueGroup.class)
public @interface EnsureFeatureFlagValue {
    String namespace();
    String key();
    String value();
