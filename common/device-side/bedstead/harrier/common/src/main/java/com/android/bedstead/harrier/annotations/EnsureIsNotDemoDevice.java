...
import static com.android.bedstead.nene.settings.CommonSettings.DEVICE_DEMO_MODE;
...
/**
 * Ensure that the device is not set as a demo device.
 */
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@EnsureGlobalSettingSet(key = DEVICE_DEMO_MODE, value = "0")
public @interface EnsureIsNotDemoDevice {
     /**
