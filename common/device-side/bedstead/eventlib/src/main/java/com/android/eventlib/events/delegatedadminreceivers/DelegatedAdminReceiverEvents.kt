 ...
 */
interface DelegatedAdminReceiverEvents {
    /**
     ...
     */
    fun delegateChoosePrivateKeyAlias(): DelegatedAdminChoosePrivateKeyAliasEventQuery
     ...
     * `#poll` can be used to fetch results, and the result can be asserted on.
     */
    fun delegateNetworkLogsAvailable(): DelegatedAdminNetworkLogsAvailableEventQuery
     ...
     * `#poll` can be used to fetch results, and the result can be asserted on.
     */
    fun delegateSecurityLogsAvailable(): DelegatedAdminSecurityLogsAvailableEventQuery
}
