...
import com.android.cts.usespermissiondiffcertapp.ModifyInstallerPackageTest.assertPackageInstaller
...
class ModifyInstallerCrossPackageTest {
    ...
    @Test
    fun assertBefore() {
        assertPackageInstaller(OTHER_PACKAGE, null, packageManager)
    }

    @Test
    fun attemptTakeOver() {
        assertPackageInstaller(OTHER_PACKAGE, OTHER_PACKAGE, packageManager)
