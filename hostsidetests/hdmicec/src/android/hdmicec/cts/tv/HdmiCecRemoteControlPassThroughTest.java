...
public final class HdmiCecRemoteControlPassThroughTest extends BaseHdmiCecCtsTest {
    ...
    private void mapRemoteControlKeys() {
        ...
        remoteControlAudioKeys.put("VOLUME_UP", HdmiCecConstants.CEC_CONTROL_VOLUME_UP);
        remoteControlAudioKeys.put("VOLUME_DOWN", HdmiCecConstants.CEC_CONTROL_VOLUME_DOWN);
        remoteControlAudioKeys.put("VOLUME_MUTE", HdmiCecConstants.CEC_CONTROL_MUTE);
    }
