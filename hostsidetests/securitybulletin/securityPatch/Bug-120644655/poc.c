...
static const argument_t argument_mapping[] =
        ...
        { "-v", "--version", VERSION, "Version information\n" }, { "-i",
                ...
                { "--", "--display", DISPLAY, "Enable display (uses SDL)\n" }, {
                        ...
                        MAX_WD, "Maximum width (Default: 2560) \n" },
...
#ifdef CHECK_ARM_REGISTERS
IV_API_CALL_STATUS_T ivd_api_function (iv_obj_t *ps_dechdl, void *pv_api_ip, \
                                           void *pv_api_op);
#else
...
IV_API_CALL_STATUS_T release_disp_frame(void *codec_obj, UWORD32 buf_id) {
    ...
    e_dec_status = ivd_api_function((iv_obj_t *) codec_obj,
...
IV_API_CALL_STATUS_T get_version(void *codec_obj) {
    ...
    status = ivd_api_function((iv_obj_t *) codec_obj, (void *) &(s_ctl_dec_ip),
                              (void *) &(s_ctl_dec_op));
...
//    ioctl_init();
    ...
    /***********************************************************************/
    {
...

        {
            ...
            s_fill_mem_rec_ip.e_output_format = (IV_COLOR_FORMAT_T) s_app_ctx
                    .e_output_chroma_format;
            ...
            e_dec_status = ivd_api_function(NULL, (void *) &s_fill_mem_rec_ip,
        ...
        /*****************************************************************************/
        {
            ...
            s_init_ip.s_ivd_init_ip_t.u4_frm_max_wd =
                    (s_app_ctx.max_wd == 0) ?
                    MAX_FRAME_WIDTH :
                                              s_app_ctx.max_wd;
            s_init_ip.s_ivd_init_ip_t.u4_frm_max_ht =
                    (s_app_ctx.max_ht == 0) ?
                    MAX_FRAME_HEIGHT :
                                              s_app_ctx.max_ht;
