...
public class TestMediaCodec extends SecurityTestCase {
    ...
    ***********************************************************/
    ...
    public void testPocBug_33450635() throws Exception {
        String inputFiles[] = {"bug_33450635.h264"};
        runAvcDecodeMemTest(inputFiles,
                "--input " + TMP_FILE_PATH
                        + "bug_33450635.h264 --output /dev/null",
                getDevice(), null);
    }
    ...
    ***********************************************************/
    ...
    public void testPocCVE_2017_0557() throws Exception {
        ...
        runMpeg2DecodeTest(inputFiles, "--input " + TMP_FILE_PATH
                + "cve_2017_0557.m2v --num_cores 2 --num_frames -1",
                getDevice(), null);
    }
