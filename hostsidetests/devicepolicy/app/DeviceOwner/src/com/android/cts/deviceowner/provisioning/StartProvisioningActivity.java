...
import com.android.cts.deviceowner.BaseDeviceOwnerTest.BasicAdminReceiver;
...
public class StartProvisioningActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Intent provisioningIntent = new Intent(ACTION_PROVISION_MANAGED_DEVICE)
                    .putExtra(DevicePolicyManager.EXTRA_PROVISIONING_DEVICE_ADMIN_COMPONENT_NAME,
                            BasicAdminReceiver.getComponentName(this))
