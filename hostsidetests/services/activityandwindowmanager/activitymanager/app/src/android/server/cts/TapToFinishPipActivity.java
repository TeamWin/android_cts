...
public class TapToFinishPipActivity extends Activity {
    ...
    static void launchActivity(Activity caller) {
        launchActivity(caller, new Rect(0, 0, 500, 500));
    }

    static void launchActivity(Activity caller, Rect bounds) {
        final Intent intent = new Intent(caller, TapToFinishPipActivity.class);
