 ...
 * Run: cts/hostsidetests/services/activityandwindowmanager/util/run-test CtsActivityManagerDeviceTestCases android.server.cts.KeyguardTests
 */
public class KeyguardTests extends KeyguardTestBase {
    ...
    public void testTranslucentShowWhenLockedActivity() throws Exception {
        ...
        launchActivity("ShowWhenLockedTranslucentActivity");
        mAmWmState.computeState(new String[] { "ShowWhenLockedTranslucentActivity"});
        mAmWmState.assertVisibility("ShowWhenLockedTranslucentActivity", true);
        gotoKeyguard();
        mAmWmState.computeState(null);
        mAmWmState.assertVisibility("ShowWhenLockedTranslucentActivity", true);
    ...
    public void testDialogShowWhenLockedActivity() throws Exception {
        ...
        mAmWmState.computeState(new String[] { "ShowWhenLockedDialogActivity"});
    ...
    public void testDismissKeyguardActivity() throws Exception {
        ...
        mAmWmState.computeState(new String[] { "DismissKeyguardActivity"});
    ...
    public void testDismissKeyguardActivity_method_turnScreenOn() throws Exception {
        ...
        mAmWmState.waitForKeyguardGone();
        mAmWmState.computeState(new String[] { "TurnScreenOnDismissKeyguardActivity"});
    ...
    public void testKeyguardLock() throws Exception {
        ...
        mAmWmState.computeState(new String[] { "KeyguardLockActivity" });
    ...
    public void testScreenOffWhileOccludedStopsActivity() throws Exception {
        ...
        mAmWmState.computeState(new String[] { "ShowWhenLockedAttrActivity" });
